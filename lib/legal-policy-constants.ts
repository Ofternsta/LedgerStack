...
export const PLAN_TIER_LEGAL_SUMMARIES = [
  `Trial (7 days, card required) — ${PLAN_PROJECT_LIMITS_DISPLAY.trial}, ${PLAN_AI_LIMITS_DISPLAY.trial} AI summaries and Project AI chat replies per calendar month (shared pool), images/PDF uploads only; no exports, workers, client portal, e-signatures, calendar, or team chat.`,
