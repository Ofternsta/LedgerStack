...
export const PLAN_TIER_LEGAL_SUMMARIES = [
  ...
  `Starter ($20/month) — ${PLAN_STAFF_LIMITS_DISPLAY.starter}, ${PLAN_PROJECT_LIMITS_DISPLAY.starter}, ${PLAN_AI_LIMITS_DISPLAY.starter} AI summaries and Project AI chat replies per calendar month (shared pool), standard PDF export, automatic backups (${BACKUP_LIMITS_DISPLAY.starter} retained); no client portal or e-signatures.`,
