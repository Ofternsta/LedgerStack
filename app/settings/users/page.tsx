  ...
  return (
    <div className="min-h-dvh flex flex-col">
      ...
      <main className="flex-1 safe-x px-4 py-4 max-w-lg mx-auto w-full pb-8 safe-bottom space-y-4">
        ...
        <p className="text-sm text-amber-900 bg-amber-50 border border-amber-200 rounded-xl p-3 leading-relaxed">
            ...
            >
              ...
              {!u.is_platform_owner && (
                <button
                  ...
                  className="w-full border border-red-200 text-red-700 py-3 rounded-xl text-sm font-semibold min-h-[48px] disabled:opacity-50 active:bg-red-50"
                >
